...
const Calc = () => {
  ...
  return (
    <div style={{ padding: '40px', fontSize: '18px' }}>
      <h1 style={{ color: 'red' }}>Health Calculator</h1>
      ...
      <div style={{ flexBasis: '30%', marginTop: '50px' }}>
        ...
        <button onClick={calculateBMI} style={{ backgroundColor: 'black', color: 'white', width: '100%', fontSize: '18px' }}>Calculate BMI</button>
      </div>
      
      <div style={{ flexBasis: '30%' , marginTop: '50px'}}>
        <p>Basal Metabolic Rate (BMR) - The number of calories your body needs to accomplish basic life-sustaining functions.</p>
        <button onClick={calculateBMR} style={{ backgroundColor: 'black', color: 'white', width: '100%', fontSize: '18px' }}>Calculate BMR</button>
      </div>
      
      <div style={{ flexBasis: '30%' , marginTop: '50px'}}>
        <p>Ideal Body Weight (IBW) - The optimal weight associated with maximum life expectancy for a given height.</p>
        <button onClick={calculateIBW} style={{ backgroundColor: 'black', color: 'white', width: '100%', fontSize: '18px' }}>Calculate IBW</button>
      </div>
      
      <div style={{ flexBasis: '30%', marginTop: '50px' }}>
        <p>Body Fat Percentage (BFP) - The percentage of your body mass that is made up of fat.</p>
        <button onClick={calculateBFP} style={{ backgroundColor: 'black', color: 'white', width: '100%', fontSize: '18px' }}>Calculate BFP</button>
      </div>
      
      <div style={{ flexBasis: '30%', marginTop: '50px' }}>
        <p>Waist to Hip Ratio (WHR) - Indicates your probable health risks based on the distribution of fat in your body.</p>
        <button onClick={calculateWHR} style={{ backgroundColor: 'black', color: 'white', width: '100%', fontSize: '18px' }}>Calculate WHR</button>
      </div>
      
      <div style={{ flexBasis: '30%' , marginTop: '50px'}}>
        <p>A Body Shape Index (ABSI) - A measure of body roundness or belly fat independent of BMI.</p>
        <button onClick={calculateABSI} style={{ backgroundColor: 'black', color: 'white', width: '100%', fontSize: '18px' }}>Calculate ABSI</button>
      </div>
      
      <div style={{ flexBasis: '30%', marginTop: '50px' }}>
        <p>Total Daily Energy Expenditure (TDEE) - The total number of calories you burn in a day.</p>
        <button onClick={calculateTDEE} style={{ backgroundColor: 'black', color: 'white', width: '100%', fontSize: '18px' }}>Calculate TDEE</button>
      </div>
  ...
  <div style={{ marginTop: '100px', fontSize: '20px', backgroundColor: '#f2f2f2', padding: '20px', borderRadius: '8px' }}>
          <h2 style={{ color: 'red', marginBottom: '20px' }}>Output Values</h2>
         ...
         <button onClick={resetValues} style={{ marginTop: '20px', backgroundColor: 'red', color: 'white', padding: '10px 20px', fontSize: '18px', borderRadius: '5px' }}>
        Clear
      </button>
    </div>
