...
const AboutFitTrack = () => (
  <Box sx={{
    ...
    <Typography variant="h4" gutterBottom textAlign="center" color="white" fontWeight="900">
      About MedSynC
    </Typography>
...
const ContactForm = () => {
  ...
  return (
    ...
    >
      {submitted ? (
        <Typography variant="h4" textAlign="center" gutterBottom sx={{ color: '#FF6666', fontWeight: 'bold', fontSize: '24px' }}>
          Thank you for submitting!
        </Typography>
      ) : (
        <Box component="form" onSubmit={handleSubmitForm} noValidate autoComplete="off">
          <Typography variant="h4" textAlign="center" gutterBottom bgcolor="white" color="red">
            Get In Touch  
          </Typography>
          <TextField
            fullWidth
          ...
          <TextField
            ...
            onChange={handleInputChange}
          />
          <Button type="submit" variant="contained" style={{ backgroundColor: '#FF6666', color: '#fff' }}  disabled={state.submitting}>
            Submit
          </Button>
          <ValidationError
            prefix="Oops!"
